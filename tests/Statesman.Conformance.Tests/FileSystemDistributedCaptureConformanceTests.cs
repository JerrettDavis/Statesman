...
/// <summary>
/// The shared distributed-capture suite, run against the filesystem provider. It has no real
...
/// </summary>
public sealed class FileSystemDistributedCaptureConformanceTests : DistributedCaptureConformanceTests
{
